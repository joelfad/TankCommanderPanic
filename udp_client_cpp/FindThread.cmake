...
if(CMAKE_HAVE_SPROC_H AND NOT CMAKE_THREAD_PREFER_PTHREAD)
  ...
  if(CMAKE_HAVE_PTHREAD_H)
    ...
    if(NOT Threads_FOUND)
      ...
      set(HAVE_THREADS_LIBRARY)

      check_symbol_exists(pthread_create pthread.h CMAKE_HAVE_LIBC_CREATE)
      if(CMAKE_HAVE_LIBC_CREATE)
        set(CMAKE_THREAD_LIBS_INIT "")
        set(HAVE_THREADS_LIBRARY 1)
        set(Threads_FOUND TRUE)
      endif()

      if(NOT HAVE_THREADS_LIBRARY)
...
if(THREADS_FOUND AND NOT HAVE_CMAKE_THREADS_TARGET)
  ...
  set_property(TARGET CMake::Threads PROPERTY INTERFACE_COMPILE_OPTIONS "${CMAKE_THREAD_DEFS_INIT}")
